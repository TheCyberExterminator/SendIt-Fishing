...
**Should I send it today?** A free, single-file, offline-first fishing forecast for Australian anglers.
No backend. No paid APIs. No API keys. No signup. No ads. Drop it on GitHub Pages and go.
...
1. Put `index.html` and `sw.js` in a repo (root).
2. Settings → Pages → deploy from branch (root).
3. Open `https://<you>.github.io/<repo>/` — installable on iPhone/Android.
